...
PROFILE_SEARCHES: dict[str, dict[str, list[str]]] = {
    "tech_enthusiast": {
        "social":    ["AI development", "open source projects", "Rust programming", "semiconductor news"],
        "ecommerce": ["mechanical keyboard", "ultrawide monitor", "Raspberry Pi kit", "programming books"],
        "travel":    ["Silicon Valley hotel", "Tokyo tech district", "Berlin startup scene"],
        "streaming": ["coding tutorial", "tech podcast", "Linux setup guide", "AI explained"],
    },
    "food_blogger": {
        "social":    ["sourdough recipe", "coffee brewing", "Italian pasta", "food photography tips"],
        "ecommerce": ["espresso machine", "dutch oven", "ceramic dinnerware", "chef knife set"],
        "travel":    ["Barcelona food tour", "Tokyo street food", "Paris patisserie"],
        "streaming": ["cooking show", "baking tutorial", "wine tasting", "restaurant review"],
    },
    "traveler": {
        "social":    ["backpacking tips", "national parks", "hidden gem destinations", "solo travel"],
        "ecommerce": ["hiking backpack", "travel adapter", "packing cubes", "GoPro accessories"],
        "travel":    ["Bali resort", "Swiss Alps hotel", "Kyoto ryokan", "Patagonia trek"],
        "streaming": ["travel documentary", "drone footage", "hiking guide", "van life"],
    },
    "college_student": {
        "social":    ["GRE study tips", "internship advice", "dorm room setup", "college life vlog"],
        "ecommerce": ["desk lamp", "noise cancelling headphones", "backpack", "planner notebook"],
        "travel":    ["student flight deals", "hostel Europe", "spring break ideas"],
        "streaming": ["study playlist", "focus music", "campus tour", "student vlog"],
    },
    "retiree": {
        "social":    ["gardening tips", "yoga for beginners", "bird watching", "classical music"],
        "ecommerce": ["gardening tools", "yoga mat", "bird feeder", "watercolor paint set"],
        "travel":    ["Caribbean cruise", "Tuscany villa", "national park tour", "river cruise Europe"],
        "streaming": ["gardening show", "classical concert", "nature documentary", "meditation guide"],
    },
    "teenager": {
        "social":    ["Fortnite clips", "NBA highlights", "anime edits", "Minecraft build"],
        "ecommerce": ["gaming mouse", "anime figure", "basketball shoes", "RGB keyboard"],
        "travel":    ["theme park", "anime convention", "gaming convention"],
        "streaming": ["gaming music", "NBA highlights", "anime opening songs", "Twitch streamer"],
    },
}
